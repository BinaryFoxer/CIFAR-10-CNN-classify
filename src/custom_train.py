...
logger = setup_logger(log_dir=str(LOG_DIR), log_file='custom_train')

def train_model():
    '''
    Training custom ResNet models
    '''
    ...
    logger.info("Starting customResNet training on CIFAR-10...")
    ...
    for epoch in range(EPOCHS):
        ...
        if test_accuracy >= best_accuracy:
            ...
            },f'{MODEL_SAVE_DIR}/best_custom_model.pth')
        ...
        #         'train_accuracy': train_accuracy,
        #         'test_accuracy': test_accuracy,
        #     }, f'{MODEL_SAVE_DIR}/custom_checkpoint_epoch_{epoch+1}.pth')
    ...
    torch.save({
        ...
        'train_loss': avg_loss,
        'train_accuracy': train_accuracy,
    }, f'{MODEL_SAVE_DIR}/custom_final_model.pth')
